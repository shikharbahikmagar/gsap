...
function Conservation() {
  return (
    <div className='card w-full max-w-[800px] lg:mx-24 lg:my-28 bg-white z-12 relative overflow-hidden rounded-xl cursor-pointer group'> 
    <div className='absolute w-full h-full group-hover:bg-teal-800 opacity-0 group-hover:opacity-40 transition-all duration-1000 overflow-visible'>
       ...
       <div className='absolute top-0 right-0 lg:max-w-lg mx-auto opacity-0 group-hover:opacity-100 transition-all duration-1000 p-8'>
